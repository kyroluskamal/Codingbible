...
namespace CodingBible.Migrations.ApplicationDb
{
    ...
    [Migration("20220706203154_AddNameSlugFragment2")]
    partial class AddNameSlugFragment2
    {
            ...
            modelBuilder.Entity("CodingBible.Models.Courses.Course", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 7, 6, 22, 31, 54, 460, DateTimeKind.Local).AddTicks(2207));
                    ...
                    b.Property<DateTime>("LastModified")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 7, 6, 22, 31, 54, 460, DateTimeKind.Local).AddTicks(2831));
            ...
            modelBuilder.Entity("CodingBible.Models.Posts.Post", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 7, 6, 22, 31, 54, 460, DateTimeKind.Local).AddTicks(479));
                    ...
                    b.Property<DateTime>("LasModified")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 7, 6, 22, 31, 54, 460, DateTimeKind.Local).AddTicks(986));
