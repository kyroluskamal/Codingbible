...
namespace CodingBible.Migrations.ApplicationDb
{
    ...
    [Migration("20220614173222_fsdfsfs")]
    partial class fsdfsfs
    {
            ...
            modelBuilder.Entity("CodingBible.Models.Courses.Course", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 6, 14, 19, 32, 22, 108, DateTimeKind.Local).AddTicks(3667));
                    ...
                    b.Property<DateTime>("LastModified")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 6, 14, 19, 32, 22, 108, DateTimeKind.Local).AddTicks(4688));
            ...
            modelBuilder.Entity("CodingBible.Models.Posts.Post", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 6, 14, 19, 32, 22, 108, DateTimeKind.Local).AddTicks(778));
                    ...
                    b.Property<DateTime>("LasModified")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 6, 14, 19, 32, 22, 108, DateTimeKind.Local).AddTicks(1731));
            ...
            modelBuilder.Entity("CodingBible.Models.Courses.Course", b =>
                {
                    ...
                    b.HasOne("CodingBible.Models.SlugMap.SlugMap_Courses", "SlugMap")
                        .WithMany()
            ...
            modelBuilder.Entity("CodingBible.Models.Courses.CourseCategory", b =>
                {
                    ...
                    b.HasOne("CodingBible.Models.SlugMap.SlugMap_CourseCategory", "SlugMap")
                        .WithMany()
                        .HasForeignKey("SlugMapId");
            ...
            modelBuilder.Entity("CodingBible.Models.Courses.Lesson", b =>
                {
                    ...
                    b.HasOne("CodingBible.Models.SlugMap.SlugMap_Lessons", "SlugMap")
                        .WithMany()
                        .HasForeignKey("SlugMapId");
            ...
            modelBuilder.Entity("CodingBible.Models.Courses.Section", b =>
                {
                    ...
                    b.HasOne("CodingBible.Models.SlugMap.SlugMap_Sections", "SlugMap")
                        .WithMany()
                        .HasForeignKey("SlugMapId");
